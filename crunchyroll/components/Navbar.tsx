    ...
    <nav className='w-full flex justify-around bg-neutral-850 text-white mx-auto h-14 fixed z-50 top-0'>
        <div className='flex items-center'>
            ...
            <div className='h-full flex'>
                ...
                <div
                    className='h-full flex items-center px-4 cursor-pointer hover:bg-neutral-950 text-neutral-250 hover:text-white'>
                    <a href="">Manga</a>
                </div>
                <div
                    className='h-full flex items-center px-4 cursor-pointer hover:bg-neutral-950 text-neutral-250 hover:text-white'>
                ...
                <div className='h-full flex items-center'>
                    <div className={menuSelected===Menu.News
                        ? 'h-full flex items-center px-4 cursor-pointer bg-neutral-950 text-white fill-white'
                        : 'h-full flex items-center px-4 cursor-pointer hover:bg-neutral-950 text-neutral-250 hover:text-white fill-neutral-250 hover:fill-white'
                        } onClick={()=> handleChangeMenu(Menu.News)}>
                        <a href="#">Noticias</a>
                        <svg className="h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                            data-t="dropdown-svg" aria-labelledby="dropdown-svg" aria-hidden="true" role="img">
                            <title id="dropdown-svg">Menú desplegable</title>
                    ...
                    <div className={menuSelected===Menu.News ? 'absolute top-14 bg-neutral-950'
                        : 'absolute top-14 bg-neutral-950 hidden' }>
        ...
        <div className='h-full flex'>
            <div
                className='h-full flex items-center px-3.5 hover:bg-neutral-950 cursor-pointer fill-neutral-250 hover:fill-white'>
                <svg className="h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-t="search-svg"
                    aria-labelledby="search-svg" aria-hidden="false" role="img">
            ...
            <div
                className='h-full flex items-center px-3.5 hover:bg-neutral-950 cursor-pointer fill-neutral-250 hover:fill-white'>
                <svg className="h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-t="watchlist-svg"
                    aria-labelledby="watchlist-svg" aria-hidden="false" role="img">
                    <title id="watchlist-svg">Mi Lista</title>
                    <path
            ...
            <div className='h-full flex items-center relative'>
                <div className={menuSelected===Menu.User
                    ? 'h-full flex items-center px-3.5 bg-neutral-950 cursor-pointer fill-white'
                    : 'h-full flex items-center px-3.5 hover:bg-neutral-950 cursor-pointer fill-neutral-250 hover:fill-white'
                    } onClick={()=> handleChangeMenu(Menu.User)}>
                    <img src={user.src} alt="" className='w-9 rounded-full' />
                    <svg className="h-6 ml-1.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                        data-t="dropdown-svg" aria-labelledby="dropdown-svg" aria-hidden="true" role="img">
                        <title id="dropdown-svg">Menú desplegable</title>
                        <path d="M7 10h10l-5 5z"></path>
                    </svg>
                </div>
                <div className={menuSelected===Menu.User ? 'absolute top-14 right-0 bg-neutral-950 w-96'
                    : 'absolute top-14 bg-neutral-950 w-96 hidden' }>
                    <div className='flex flex-col pt-3'>
                        <div className='flex px-4 pt-2 pb-3 border-b-2 border-neutral-850'>
                            ...
                            <div className='flex flex-col'>
                                ...
                                <span className='flex fill-[#fab818] text-[#fab818]'>
                                    <svg className="w-4 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"
                        ...
                        <div className='flex flex-col py-3 border-b-2 border-neutral-850'>
                            <div className='w-full px-6 py-2.5 hover:bg-neutral-850 cursor-pointer flex'>
                                <svg className='h-6 fill-white mr-4' xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div className='w-full px-6 py-2.5 hover:bg-neutral-850 cursor-pointer flex'>
                                <svg className='h-6 fill-white mr-4' xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24" data-t="custom-list-svg" aria-labelledby="custom-list-svg"
                                    aria-hidden="true" role="img">
                                    <title id="custom-list-svg">Crunchylista</title>
                                    <path
                                        d="M22 17v2H6v-2h16zM3 17c.552 0 1 .448 1 1s-.448 1-1 1-1-.448-1-1 .448-1 1-1zm19-6v2H6v-2h16zM3 11c.552 0 1 .448 1 1s-.448 1-1 1-1-.448-1-1 .448-1 1-1zm19-6v2H6V5h16zM3 5c.552 0 1 .448 1 1s-.448 1-1 1-1-.448-1-1 .448-1 1-1z">
                                    </path>
                                </svg>
                            ...
                            <div className='w-full px-6 py-2.5 hover:bg-neutral-850 cursor-pointer flex'>
                                <svg className="h-6 fill-white mr-4" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24" data-t="history-svg" aria-labelledby="history-svg"
                                    aria-hidden="true" role="img">
                                    <title id="history-svg">Historial</title>
                                    <path
                                        d="M11 7a1 1 0 0 1 2 0v5.411l-3.293 3.293a1 1 0 0 1-1.414-1.414L11 11.583V7zm1-5c5.514 0 10 4.486 10 10s-4.486 10-10 10a9.977 9.977 0 0 1-6.667-2.547 1 1 0 1 1 1.334-1.49A7.986 7.986 0 0 0 12 20c4.411 0 8-3.589 8-8s-3.589-8-8-8c-4.072 0-7.436 3.06-7.931 7H6l-3 3-3-3h2.051C2.554 5.954 6.823 2 12 2z">
                                    </path>
                                </svg>
                                <span>Historial</span>
                            </div>
                        ...
                        <div className='flex flex-col py-3 border-b-2 border-neutral-850'>
                            <div className='w-full px-6 py-2.5 hover:bg-neutral-850 cursor-pointer flex'>
                                <svg className='w-6 h-6 fill-white mr-4' xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div className='flex flex-col py-3 border-b-2 border-neutral-850'>
                            <div className='w-full px-6 py-2.5 hover:bg-neutral-850 cursor-pointer flex'>
                                <svg className="w-6 h-6 fill-white mr-4" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24" data-t="feedback-svg" aria-labelledby="feedback-svg"
                                    aria-hidden="true" role="img">
                                    <title id="feedback-svg">Deja tu opinión</title>
                                    <path
                                        d="M22 1.2v17h-5.5L12 22.8l-4.5-4.6H2v-17h20zm-2 1.9H4v13h4.4l3.6 3.8 3.6-3.7H20V3.1zM12 9c.773 0 1.4.627 1.4 1.4 0 .773-.627 1.4-1.4 1.4-.773 0-1.4-.627-1.4-1.4 0-.773.627-1.4 1.4-1.4zm4.4 0c.773 0 1.4.627 1.4 1.4 0 .773-.627 1.4-1.4 1.4-.773 0-1.4-.627-1.4-1.4 0-.773.627-1.4 1.4-1.4zM7.6 9c.773 0 1.4.627 1.4 1.4 0 .773-.627 1.4-1.4 1.4-.773 0-1.4-.627-1.4-1.4 0-.773.627-1.4 1.4-1.4z">
                                    </path>
                                </svg>
                                <div className='flex flex-col'>
                                    <span>Deja tu opinión</span>
                                    <span className='text-sm text-neutral-400'>Nos gustaría saaber que piensas de
                                        Crunchyroll Beta.</span>
                                </div>
                            </div>
                            <div className='w-full px-6 py-2.5 hover:bg-neutral-850 cursor-pointer flex'>
                                <svg className="w-6 h-6 fill-white mr-4" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24" data-t="switch-to-crunchyroll-beta-svg"
                                    aria-labelledby="switch-to-crunchyroll-beta-svg" aria-hidden="true" role="img">
                                    <title id="switch-to-crunchyroll-beta-svg">Cambiar a Crunchyroll Beta</title>
                                    <path
                                        d="M10.425 11.639a1 1 0 01.083 1.32l-.083.094a1 1 0 01-1.32.083l-.094-.083-4.98-4.98 4.98-4.981a1 1 0 011.497 1.32l-.083.094L7.751 7.18h4.804c3.773 0 6.869 3.018 6.996 6.76l.005.26c0 3.773-3.018 6.87-6.76 6.997l-.24.004H6.434a1 1 0 01-.117-1.993l.117-.007h6.122c2.675 0 4.88-2.135 4.995-4.784l.005-.237c0-2.676-2.136-4.881-4.785-4.995l-.216-.005H7.968l2.458 2.459z">
                                    </path>
                                </svg>
                                <div className='flex flex-col'>
                                    <span>Cambiar a Crunchyroll Clásico</span>
                                    <span className='text-sm text-neutral-400'>Puedrás padar de una versión a otra
                                        tantas veces como quieras.</span>
                                </div>
                            </div>
                        </div>
                        <div className='flex flex-col py-3'>
                            <div className='w-full px-6 py-2.5 hover:bg-neutral-850 cursor-pointer flex'>
                                <svg className="w-6 h-6 fill-white mr-4" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24" data-t="sign-out-svg" aria-labelledby="sign-out-svg"
                                    aria-hidden="true" role="img">
                                    <title id="sign-out-svg">Desconectar</title>
                                    <path
                                        d="M15 15a1 1 0 0 1 1 1v5a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v5a1 1 0 1 1-2 0V4H6v16h8v-4a1 1 0 0 1 1-1zm8.923-2.618a1 1 0 0 1-.217.326l-4 3.999A.993.993 0 0 1 19 17a.999.999 0 0 1-.707-1.707L20.586 13H15a1 1 0 0 1 0-2h5.586l-2.293-2.293a.999.999 0 1 1 1.414-1.414l3.999 4a.992.992 0 0 1 .217 1.089z">
                                    </path>
                                </svg>
